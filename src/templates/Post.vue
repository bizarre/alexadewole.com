<template>
  <Focused>
    <div class="flex flex-wrap p-5 mb-10">
      <div class="m-auto w-full lg:w-10/12">
        <div id="post" class="flex flex-wrap md:justify-center">
          <div class="text-center leading-tight relative w-full text-gray-700">
            ...
            <h1 class="text-4xl text-gray-500">{{ $page.post.title }}</h1>
          </div>
          <div class="flex w-full justify-center">
            <div class="prose text-gray-500 mt-5 md:mt-10 w-full" v-html="$page.post.content" />
          </div>
        </div>
      </div>
    </div>
